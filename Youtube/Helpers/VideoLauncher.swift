...
class VideoPlayerView: UIView {
    ...
    lazy var videoSlider: UISlider = {
        ...
        slider.setThumbImage(#imageLiteral(resourceName: "home"), for: .normal)
    ...
    private func setupPlayerView() {
        ...
        if let url = NSURL(string: urlString) {
            ...
            player?.addPeriodicTimeObserver(forInterval: interval, queue: DispatchQueue?.none, using: { (progressTime) in
